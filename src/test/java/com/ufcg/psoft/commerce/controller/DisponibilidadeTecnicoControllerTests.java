...
public class DisponibilidadeTecnicoControllerTests {
    ...
    class AlteracaoDisponibilidadeEndpointTests {
        ...
        @Test
        @DisplayName(
            "Técnico altera disponibilidade para ATIVO com acesso correto e recebe 200"
        )
        void quandoTecnicoAlteraDisponibilidadeParaAtivoComAcessoCorretoRetorna200()
            throws Exception {
        ...
        @Test
        @DisplayName(
            "Técnico altera disponibilidade para DESCANSO com acesso correto e recebe 200"
        )
        void quandoTecnicoAlteraDisponibilidadeParaDescansoComAcessoCorretoRetorna200()
            throws Exception {
            // primeiro ativa
            driver
                .perform(
        ...
        @Test
        @DisplayName(
            "Resposta do endpoint não expõe o código de acesso do técnico"
        )
        void quandoDisponibilidadeEhAlteradaRespostaNaoExpoeCodioDeAcesso()
            throws Exception {
            String responseJson = driver
                .perform(
                    patch(
        ...
        void quandoDisponibilidadeEhAlteradaRespostaContemNovoStatus()
            throws Exception {
            String responseJson = driver
                .perform(
                    patch(
        ...
        @Test
        @DisplayName(
            "Técnico não pode mudar manualmente para OCUPADO — retorna 400"
        )
        void quandoTecnicoTentaMudarManualmenteParaOcupadoRetorna400()
            throws Exception {
            driver
                .perform(
                    patch(
                        ...
                        .param("acesso", ACESSO_TECNICO)
                        .param("status", StatusDisponibilidade.OCUPADO.name())
                        .contentType(MediaType.APPLICATION_JSON)
                )
        ...
        @Test
        @DisplayName(
            "Técnico em OCUPADO não pode mudar manualmente para DESCANSO — retorna 400"
        )
        void quandoTecnicoEstaOcupadoENaoPodeMudarManualmenteParaDescanso()
            throws Exception {
        ...
        @Test
        @DisplayName(
            "Solicitar mesmo status atual não gera erro e não adiciona entrada no histórico"
        )
        void quandoStatusSolicitadoEhIgualAoAtualIgnoraSilenciosamente()
            throws Exception {
            driver
                .perform(
                    patch(
    ...
    class RejeicaoAcessoInvalidoTests {
        ...
        @Test
        @DisplayName(
            "Código de acesso errado retorna 400 e não altera o status"
        )
        void quandoAcessoEhInvalidoRetorna400EStatusNaoEhAlterado()
            throws Exception {
            String responseJson = driver
                .perform(
                    patch(
            ...
            CustomErrorType erro = objectMapper.readValue(
                responseJson,
        ...
        void quandoTecnicoNaoExisteRetorna404() throws Exception {
            driver
                .perform(
                    patch(URI_TECNICOS + "/99999/disponibilidade")
                        .param("acesso", ACESSO_TECNICO)
                        .param("status", StatusDisponibilidade.ATIVO.name())
                        .contentType(MediaType.APPLICATION_JSON)
                )
    ...
    class HistoricoDisponibilidadeEndpointTests {
        ...
        @Test
        @DisplayName(
            "Após alteração via endpoint uma entrada é persistida no histórico"
        )
        void quandoDisponibilidadeEhAlteradaViaEndpointUmaEntradaEhPersistidaNoHistorico()
            throws Exception {
            driver
                .perform(
                    patch(
        ...
        @Test
        @DisplayName(
            "Três alterações via endpoint resultam em três entradas no histórico"
        )
        void quandoTresAlteracoesViaEndpointTresEntradasSaoPersistidasNoHistorico()
            throws Exception {
            driver
                .perform(
                    patch(
        ...
        @Test
        @DisplayName(
            "Falha na alteração com acesso inválido não gera entrada no histórico"
        )
        void quandoAcessoEhInvalidoNenhumaEntradaEhSalvaNoHistorico()
            throws Exception {
            driver
                .perform(
                    patch(
